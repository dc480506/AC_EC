...
if(isset($_SESSION['email']) && $_SESSION['role']=='inst_coor'){
    ...
    if(isset($_POST['createForm'])){
        ...
        $sql="INSERT INTO audit_form (`sem`,`year`,`email_id`,`timestamp_created`,`start_date`,`end_date`,`start_time`,
        `end_time`,`no_of_preferences`) VALUES('$sem','$year','$email','$timestamp','$start_date','$end_date','$start_time','$end_time','$nop')";
        ...
        $end_date=mysqli_escape_string($conn,$_POST['end_date']);
        $end_time=mysqli_escape_string($conn,$_POST['end_time']);
        $sql="UPDATE audit_form SET no_of_preferences='$nop',sem='$sem',year='$year',start_date='$start_date',end_date='$end_date'
        ,start_time='$start_time',end_time='$end_time' WHERE sem='$oldsem' AND year='$year'";
        mysqli_query($conn,$sql) or die(mysqli_error($conn));
        header("Location: ../prepare_form_ac.php");
    }
}
