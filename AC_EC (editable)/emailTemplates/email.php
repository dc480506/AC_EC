                            ...
                            <table align="center" style="width: 100%; max-width: 670px; border-top: 5px solid #b7202e; background-color: white; box-shadow: 0 6px 17px 0 rgba(0,0,0,0.04);">
                                <tr>
                                    <td style="padding: 22px;">
                                        <h4>Dear Faculty</h4>
                                        <p>You have been alloted Mobile Application Development - iOS platform for Semester- 5 for Program- UG course - OET</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td>
                            <table align="center" style="width: 100%; max-width: 680px; border-top: 1.3px solid #dddddd; padding-bottom: 16px;">
                                ...
                                <tr align="center">
                                    <td>
                                        <a href="" target="_blank" style="color: #adadad; font-size: 13px; text-decoration: none; font-weight: 500; line-height: 18px;">
