...
$sel = mysqli_query($conn,"select count(*) as totalcount from student_preference_idc");
$records = mysqli_fetch_assoc($sel);
$totalRecords = $records['totalcount'];

$sel = mysqli_query($conn,"select count(*) as totalcountfilters from student_preference_idc WHERE ".$searchQuery);
$records = mysqli_fetch_assoc($sel);
$totalRecordwithFilter = $records['totalcountfilters'];

##Fetch Record
$sql="select *  
       from student_preference_idc WHERE "
