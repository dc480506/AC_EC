...
<div id="left-page" class="col-2">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="position: fixed">
        ...
        <li class="nav-item">
            ...
            <div id="collapsePages4" class="collapse" aria-labelledby="headingUtilities"
        ...
        <li class="nav-item">
            ...
            <div id="collapsePages1" class="collapse" aria-labelledby="headingUtilities"
                data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="prepare_form_ac.php">Audit Course</a>
                    <a class="collapse-item" href="prepare_form_idc.php">Interdisciplinary Course</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapsePages2" class="collapse" aria-labelledby="headingUtilities"
                data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="audit_view.php">Audit Course</a>
                    <a class="collapse-item" href="idc_view.php">Interdisciplinary Course</a>
...
<!-- End of Sidebar -->
<!-- Content Wrapper -->
<div id="right-page" class="col-10">
