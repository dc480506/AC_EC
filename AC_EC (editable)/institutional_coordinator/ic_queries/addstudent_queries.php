...
if(isset($_SESSION['email']) && $_SESSION['role']=="inst_coor"){
    ...
    if(isset($_POST['save_changes'])){
        ...
        $dept_name_new=mysqli_escape_string($conn,$_POST['dept_name_new']);
        ...
        // if(isset($_POST['update_student'])){
            $sql="UPDATE `student` SET `email_id`='$email_id_new',`rollno`='$rollno_new',`fname`='$fname',`mname`='$mname',`lname`='$lname'
