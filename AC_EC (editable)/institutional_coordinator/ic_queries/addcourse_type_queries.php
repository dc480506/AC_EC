...
if (isset($_SESSION['email']) && $_SESSION['role'] == "inst_coor") {
    ...
    if (isset($_POST['add_new_course_type'])) {
        ...
        echo "added";
    } else if ($_POST['get_course_types']) {
        $draw = $_POST['draw'];
        $row = $_POST['start'];
        ...
        while ($row = mysqli_fetch_assoc($courseTypeRecords)) {
            ...
            $data[] = array(
                ...
                //             </button>'
                "action" => '<div class="row"><button type="button" id="edit-button" class="btn btn-primary mx-1 icon-btn action-btn">
                     <i class="fas fa-pen   "></i>
                  </button><button type="button" id="delete-button" class="btn btn-danger mx-1 icon-btn action-btn">
