...
$sel = mysqli_query($conn, "select count(*) as totalcount from course WHERE course_type_id = '$course_type_id' AND program= '$program' AND currently_active=0");
...
$sql = "SELECT DISTINCT a.cid,a.cname,a.sem,a.year FROM course a INNER JOIN course_floating_dept afd 
INNER JOIN department d ON a.cid=afd.cid AND a.sem=afd.sem AND a.year=afd.year AND a.course_type_id=afd.course_type_id AND afd.dept_id=d.dept_id WHERE a.course_type_id = '$course_type_id' AND a.program= '$program' AND currently_active=0"
...
$sql = "select cname,cid,sem,
         ...
         GROUP BY 'all') as app 
      from course a WHERE  a.course_type_id = '$course_type_id' AND a.program= '$program' AND currently_active=0 "
