...
insert_audit = """INSERT INTO course_log(cid,sem,year,cname,min,max,email_id,timestamp,program,course_type_id) VALUES """
# print(header_id)
insert_audit_floating = """INSERT INTO course_floating_dept_log VALUES """
insert_audit_applicable = """INSERT INTO course_applicable_dept_log VALUES """
sem = args[mapper['sem']]
# print(sem)
...
try:
    for x in range(1, data.nrows):
        ...
        values = (cid, sem, year, cname, min, max, email_id,
                  timestamp, program, course_type_id)
        ...
        for i in range(len(floating_dept)):
            values += "('{}','{}','{}','{}','{}','{}'),".format(cid,
                                                                course_type_id, program, sem, year, floating_dept[i])
