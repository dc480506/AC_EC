...
$sql="SELECT DISTINCT a.cid,a.sem,a.year FROM audit_course_log a INNER JOIN audit_course_floating_dept_log afd 
INNER JOIN department d ON a.cid=afd.cid AND a.sem=afd.sem AND a.year=afd.year AND afd.dept_id=d.dept_id WHERE 1"
