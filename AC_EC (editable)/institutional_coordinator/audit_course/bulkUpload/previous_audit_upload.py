...
insert_audit="""INSERT INTO audit_course_log(cid,sem,year,cname,min,max,email_id,timestamp) VALUES """    
# print(header_id)
insert_audit_floating="""INSERT INTO audit_course_floating_dept_log VALUES """
insert_audit_applicable="""INSERT INTO audit_course_applicable_dept_log VALUES """
sem=args[mapper['sem']]
# print(sem)
...
try:
    for x in range(1,data.nrows):
        ...
        # print(max)
        values=(cid,sem,year,cname,min,max,email_id,timestamp)
