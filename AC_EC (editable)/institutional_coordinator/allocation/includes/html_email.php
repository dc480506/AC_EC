...
<body>
    <div class="card" style="padding:50px; background-color:white;">
    <div style=" background-color: #f5f5f5;">
    <div style="font-size:22px;background-color:white;border:1px solid #e2e1e3;">
   
   <div style="border-bottom:1px solid #e2e1e3;padding:10px;">
   <br>
   
   <img src="../../../vendor/img/somaiya_logo2.jpg" height="80px" width="100px" style="float:right;max-width:100%">
   
    <img src="../../../vendor/img/somaiya_logo1.png" height="80px" width="100px" style="float:left;max-width:100%">
        
    <h2 style="color:black; font-family: 'sans-serif';" align="center">
    Allotment for Sem V OET Course</h2>
    ...
    <div style="font-family: 'Times New Roman';background-color:white;padding:20px;">
        ...
        <h4>Dear student,<br>
        You have been successfully alloted an OET course as per your choices given.
</h4>
    ...
    <!-- <img src="../../../vendor/img/som.png" height="150px" width="150px" style="max-width:100%;"> -->
<!-- </div> -->
</div>
</div>        
    </div>
    ...
    <!-- <div align="center" style="border: solid black 2px  max-width:100%;">
