...
$sel = mysqli_query($conn,"select count(*) as totalcount from student as stu ,student_preference_audit as stu_pref 
inner join student_audit as sa on sa.email_id=stu_pref.email_id 
where stu.email_id=stu_pref.email_id and stu_pref.allocate_status=0 and sa.currently_active=0 ");
...
$sel = mysqli_query($conn,"select count(*) as totalcountfilters from student as stu ,student_preference_audit as stu_pref 
inner join student_audit as sa on sa.email_id=stu_pref.email_id 
where stu.email_id=stu_pref.email_id and stu_pref.allocate_status=0 and sa.currently_active=0 "
...
$sql="select stu.fname,stu.lname,stu.email_id from student as stu ,student_preference_audit as stu_pref 
inner join student_audit as sa on sa.email_id=stu_pref.email_id 
where stu.email_id=stu_pref.email_id and stu_pref.allocate_status=0 and sa.currently_active=0 "
.$searchQuery.$orderQuery." limit ".$row.",".$rowperpage;
