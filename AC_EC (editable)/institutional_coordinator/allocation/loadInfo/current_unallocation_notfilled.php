...
$sel = mysqli_query($conn,"select count(*) as totalcountfilters from student_preference_audit");
$records = mysqli_fetch_assoc($sel);
...
on stud.email_id=stu_pref.email_id where stu_pref.currently_active=1)".$orderQuery." limit ".$row.",".$rowperpage;
