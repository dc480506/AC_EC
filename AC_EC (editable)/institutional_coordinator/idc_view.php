                    ...
                    <div class="modal-body">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-idc-instructions-tab" data-toggle="tab" href="#nav-idc-instructions" role="tab" aria-controls="nav-idc-instructions" aria-selected="true">Instructions</a>
                                <a class="nav-item nav-link" id="nav-idc-upload-tab" data-toggle="tab" href="#nav-idc-upload" role="tab" aria-controls="nav-idc-upload" aria-selected="false">Upload</a>
                            </div>
                        </nav>
                        <div class="tab-content" id="nav-tabContent">
                            <!--Instructions Current-->
                            <div class="tab-pane fade show active" id="nav-idc-instructions" role="tabpanel" aria-labelledby="nav-idc-instructions">

                            </div>
                            <!--end Instructions Current-->
                            <!--Upload Current-->
                            <div class="tab-pane fade" id="nav-idc-upload" role="tabpanel" aria-labelledby="nav-idc-upload">
                                <div class="container">
...
<script type="text/javascript">
    ...
    $("#bulkUploadCurrent").submit(function(e) {
        ...
        $.ajax({
            url: "view_response/bulkUpload/upload_response_queries_idc.php",
            type: 'POST',
            data: formData,
    ...
    $("#delete_selected_response_btn").click(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "ic_queries/multioperation_queries/delete_multiple_response_idc.php",
    ...
    function loadCurrent() {
        ...
        $('#dataTable-response').DataTable({
            ...
            aaSorting: [],
            ajax: {
                'url': 'view_response/loadInfo/view_idc.php'
            },
    ...
    function loadModalCurrent() {
        ...
        $.ajax({
            type: "POST",
            url: "view_response/loadModal/idc_response_modal.php",
            // data: form_serialize, 
            // dataType: "json",
            ...
            success: function(output) {
                ...
                $('#delete_response').submit(function(e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "ic_queries/idc_view_response_queries.php",
                        data: form_serialize,
                        success: function(data) {
