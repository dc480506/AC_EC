...
include_once("../../verify.php");
        ...
        if($_POST['column_selection']=='email_id'){
            $args='["'.$sem.'","'.$year.'","email_id","'.$email.'","'.$marks.'","'.$target_location.'","'.$servername.'","'.$username.'","'.$password.'","'.$dbname.'"]';
        }else if($_POST['column_selection']=='rollno'){
            $args='["'.$sem.'","'.$year.'","rollno","'.$rollno.'","'.$marks.'","'.$target_location.'","'.$servername.'","'.$username.'","'.$password.'","'.$dbname.'"]';
        }
