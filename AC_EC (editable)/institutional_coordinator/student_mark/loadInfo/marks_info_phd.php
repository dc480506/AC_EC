...
$query = "select count(*) as totalcount from student_marks s where program='PHD' $role_restriction";
$sel = mysqli_query($conn, $query);
// echo $query;
$records = mysqli_fetch_assoc($sel);
$totalRecords = $records['totalcount'];

$query = "select count(*) as totalcountfilters from student_marks m INNER JOIN student s ON m.email_id=s.email_id INNER JOIN department d ON s.dept_id=d.dept_id WHERE m.program='PHD' " . $role_restriction . " and " . $searchQuery . "&& (" . $filterQuery . ")";
$sel = mysqli_query($conn, $query);
// echo $query;
$records = mysqli_fetch_assoc($sel);
...
from student_marks m INNER JOIN student s ON m.email_id=s.email_id INNER JOIN department d ON s.dept_id=d.dept_id WHERE m.program='PHD' " . $role_restriction . " && "
