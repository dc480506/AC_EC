                ...
                <div class="card-body">
                    ...
                    <form id="prefForm" onsubmit="return confirmpref();" method="post" action="student_queries/store_preference.php">
                        ...
                        for ($i = 1; $i <= $row1['no_of_preferences']; $i++) { ?>
                            ...
                            <select style="height: 40px; border-radius:5px; border-color:gray" id="cname<?php echo $i; ?>" class="courses" aria-haspopup="true" aria-expanded="false" name="cname<?php echo $i; ?>" required>
...
<script>
    $(document).ready(function() {
        $('.courses').select2({
            selectionCssClass: "custom-dropdown"
        });
