                ...
                <div class="card-header py-3">
                    <div class="row align-items-center">
                        <h1 class="h3 mb-4 text-gray-800">
                            ...
                            echo $course_name . " ";
                            $logger->studentsRecordsViewed($_SESSION["email"], "edit $course_name form");
                            ?>
                            Form</h1>
                    </div>
                    <div class="row align-items-center">
                ...
                <div class="card-body">
                    ...
                    <form id="prefForm" onsubmit="return confirmpref();" method="post" action="student_queries/edit_preference.php">
                        ...
                        for ($i = 1; $i <= $row1['no_of_preferences']; $i++) { ?>
                            ...
                            <select id="cname<?php echo $i; ?>" class="btn btn-info dropdown-toggle" aria-haspopup="true" aria-expanded="false" name="cname<?php echo $i; ?>" style="color:#ffffff;" required>
