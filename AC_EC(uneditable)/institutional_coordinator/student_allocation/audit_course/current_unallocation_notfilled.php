...
where stu_f.form_type='audit' and stu_f.form_filled=0 and stu_f.currently_active=1");
...
student as stu inner join 
student_form as stu_f on stu.email_id=stu_f.email_id 
where stu_f.form_type='audit' and stu_f.form_filled=0 and stu_f.currently_active=1".$searchQuery.$orderQuery);
$records = mysqli_fetch_assoc($sel);
...
student_form as stu_f on stu.email_id=stu_f.email_id 
where stu_f.form_type='audit' and stu_f.form_filled=0 and stu_f.currently_active=1".$searchQuery.$orderQuery." limit ".$row.",".$rowperpage;
